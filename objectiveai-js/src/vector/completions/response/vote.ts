...
export const VectorCompletionsResponseVoteSchema = z.object({
  ...
  ensemble_index: z.number().int().min(0).max(18446744073709552000).describe("Index of the agent configuration within the ensemble."),
  flat_ensemble_index: z.number().int().min(0).max(18446744073709552000).describe("Flattened index accounting for agent counts in the ensemble."),
