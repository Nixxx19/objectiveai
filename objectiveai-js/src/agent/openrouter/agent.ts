...
export const AgentOpenrouterAgentSchema = z.object({
  frequency_penalty: z.number().min(-3.4028234663852886e+38).max(3.4028234663852886e+38).nullable().describe("Penalizes tokens based on their frequency in the output so far (-2.0 to 2.0).").optional(),
  id: z.string().describe("The deterministic content-addressed ID (22-character base62 string)."),
  logit_bias: z.record(z.string(), z.number().int().min(-9223372036854776000).max(9223372036854776000)).nullable().describe("Token ID to bias mapping (-100 to 100). Positive values increase likelihood.").optional(),
  max_completion_tokens: z.number().int().min(0).max(18446744073709552000).nullable().describe("Maximum tokens in the completion.").optional(),
  max_tokens: z.number().int().min(0).max(18446744073709552000).nullable().describe("Maximum tokens (OpenRouter variant of max_completion_tokens).").optional(),
  ...
  repetition_penalty: z.number().min(-3.4028234663852886e+38).max(3.4028234663852886e+38).nullable().describe("Repetition penalty (0.0 to 2.0). Values > 1.0 penalize repetition.").optional(),
  ...
  temperature: z.number().min(-3.4028234663852886e+38).max(3.4028234663852886e+38).nullable().describe("Sampling temperature (0.0 to 2.0). Higher = more random.").optional(),
  top_a: z.number().min(-3.4028234663852886e+38).max(3.4028234663852886e+38).nullable().describe("Top-a sampling parameter (0.0 to 1.0).").optional(),
  top_k: z.number().int().min(0).max(18446744073709552000).nullable().describe("Top-k sampling: only consider the k most likely tokens.").optional(),
  ...
  top_p: z.number().min(-3.4028234663852886e+38).max(3.4028234663852886e+38).nullable().describe("Nucleus sampling probability (0.0 to 1.0).").optional(),
