//! `LogReference` for builder-completion entries within a
//! laboratory execution log file.
...
#[schemars(rename = "laboratories.executions.response.streaming.builder_log_reference.LogReference")]
