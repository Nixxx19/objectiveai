...
pub fn into_parts_for_prompt(
    vector_responses: &[objectiveai::agent::completions::message::RichContent],
    vector_pfx_indices: &[(String, usize)],
) -> Vec<objectiveai::agent::completions::message::RichContentPart> {
        ...
        match &vector_responses[*vector_response_index] {
            ...
            objectiveai::agent::completions::message::RichContent::Parts(rich_parts) => {
                for rich_part in rich_parts {
                    match rich_part {
                        objectiveai::agent::completions::message::RichContentPart::Text { text } => {
                            parts.push(
                                objectiveai::agent::completions::message::RichContentPart::Text {
                                    text: json_escape::escape_str(text).to_string(),
                                },
