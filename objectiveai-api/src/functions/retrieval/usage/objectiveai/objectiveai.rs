//! ObjectiveAI API implementation of the Function usage client.

use crate::ctx;
use std::sync::Arc;

/// Retrieves Function usage statistics via the ObjectiveAI API.
...
impl ObjectiveAiClient {
    /// Creates a new ObjectiveAI Function usage client.
