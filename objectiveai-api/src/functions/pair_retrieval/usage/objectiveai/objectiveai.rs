//! ObjectiveAI API implementation of the Function-Profile pair usage client.

use crate::ctx;
use std::sync::Arc;

/// Retrieves Function-Profile pair usage statistics via the ObjectiveAI API.
...
impl ObjectiveAiClient {
    /// Creates a new ObjectiveAI pair usage client.
