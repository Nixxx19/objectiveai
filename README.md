...
```bash
objectiveai agents spawn standard \
...
CLI: `objectiveai agents spawn standard --agent remote=github,owner=...,repository=... --messages-inline '...'`. SDK: `agentsCompletionsCreateAgentCompletion` (JS) / `create_agent_completion` (Python) / `agent::completions::http::create_agent_completion` (Rust).
...
objectiveai agents spawn standard --agent remote=github,owner=...,repository=... --messages-inline '...'
