        ...
        match self {
            ...
            Commands::GetSwarmResponse { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/swarm.GetSwarmResponse.json"
                ))
            ...
            Commands::InlineSwarm { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/swarm.InlineSwarm.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::InlineSwarmBase { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/swarm.InlineSwarmBase.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::InlineSwarmBaseOrRemote { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/swarm.InlineSwarmBaseOrRemote.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::ListSwarmResponse { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/swarm.ListSwarmResponse.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::ListSwarmsRequest { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/swarm.ListSwarmsRequest.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::ListSwarmsSource { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/swarm.ListSwarmsSource.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::RemoteSwarm { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/swarm.RemoteSwarm.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::RemoteSwarmBase { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/swarm.RemoteSwarmBase.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::Swarm { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/swarm.Swarm.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::SwarmBase { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/swarm.SwarmBase.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::UsageSwarmResponse { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/swarm.UsageSwarmResponse.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
