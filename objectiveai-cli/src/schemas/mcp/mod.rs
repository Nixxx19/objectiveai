        ...
        match self {
            ...
            Commands::CompletionsCapability { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/mcp.CompletionsCapability.json"
                ))
            ...
            Commands::Implementation { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/mcp.Implementation.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::InitializeResult { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/mcp.InitializeResult.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::JsonRpcError { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/mcp.JsonRpcError.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::JsonRpcNotification { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/mcp.JsonRpcNotification.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::JsonRpcRequest { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/mcp.JsonRpcRequest.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::LoggingCapability { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/mcp.LoggingCapability.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::PromptsCapability { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/mcp.PromptsCapability.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::ResourcesCapability { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/mcp.ResourcesCapability.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::ServerCapabilities { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/mcp.ServerCapabilities.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::TasksCancelCapability { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/mcp.TasksCancelCapability.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::TasksCapability { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/mcp.TasksCapability.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::TasksListCapability { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/mcp.TasksListCapability.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::TasksRequestsCapability { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/mcp.TasksRequestsCapability.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::TasksToolsCallCapability { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/mcp.TasksToolsCallCapability.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::TasksToolsCapability { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/mcp.TasksToolsCapability.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::ToolsCapability { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/mcp.ToolsCapability.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
