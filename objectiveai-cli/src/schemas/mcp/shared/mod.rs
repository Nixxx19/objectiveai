        ...
        match self {
            ...
            Commands::Annotations { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../../objectiveai-json-schema/mcp.shared.Annotations.json"
                ))
            ...
            Commands::BlobResourceContents { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../../objectiveai-json-schema/mcp.shared.BlobResourceContents.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::Icon { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../../objectiveai-json-schema/mcp.shared.Icon.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::IconTheme { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../../objectiveai-json-schema/mcp.shared.IconTheme.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::ResourceContents { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../../objectiveai-json-schema/mcp.shared.ResourceContents.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::ResourceContentsUnion { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../../objectiveai-json-schema/mcp.shared.ResourceContentsUnion.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::Role { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../../objectiveai-json-schema/mcp.shared.Role.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::TextResourceContents { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../../objectiveai-json-schema/mcp.shared.TextResourceContents.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
