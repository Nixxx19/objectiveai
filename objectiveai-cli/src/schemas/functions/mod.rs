        ...
        match self {
            ...
            Commands::AlphaInlineFunction { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/functions.AlphaInlineFunction.json"
                ))
            ...
            Commands::AlphaRemoteFunction { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/functions.AlphaRemoteFunction.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::CompiledTask { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/functions.CompiledTask.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::FullFunction { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/functions.FullFunction.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::FullInlineFunction { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/functions.FullInlineFunction.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::FullRemoteFunction { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/functions.FullRemoteFunction.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::Function { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/functions.Function.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::FunctionType { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/functions.FunctionType.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::GetFunctionResponse { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/functions.GetFunctionResponse.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::InlineFunction { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/functions.InlineFunction.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::InlineProfile { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/functions.InlineProfile.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::InlineTasksProfile { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/functions.InlineTasksProfile.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::ListFunctionProfilePairItem { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/functions.ListFunctionProfilePairItem.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::ListFunctionResponse { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/functions.ListFunctionResponse.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::ListFunctionsRequest { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/functions.ListFunctionsRequest.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::ListFunctionsSource { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/functions.ListFunctionsSource.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::Profile { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/functions.Profile.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::RemoteFunction { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/functions.RemoteFunction.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::RemoteProfile { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/functions.RemoteProfile.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::RemoteTasksProfile { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/functions.RemoteTasksProfile.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::ScalarFunctionTask { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/functions.ScalarFunctionTask.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::Task { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/functions.Task.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::TaskExpression { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/functions.TaskExpression.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::TaskProfile { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/functions.TaskProfile.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::UsageFunctionResponse { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/functions.UsageFunctionResponse.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::VectorCompletionTask { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/functions.VectorCompletionTask.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
            ...
            Commands::VectorFunctionTask { .. } => {
                let schema: serde_json::Value = serde_json::from_str(include_str!(
                    "../../../../objectiveai-json-schema/functions.VectorFunctionTask.json"
                ))
                .expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
