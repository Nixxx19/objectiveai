...
impl LogsClient {
    ...
    async fn list_endpoint(&self, endpoint: &str, offset: usize, limit: usize) -> Result<Vec<ListItem>, super::super::Error> {
    ...
    pub async fn list_agent_completions(&self, offset: usize, limit: usize) -> Result<Vec<ListItem>, super::super::Error> {
        self.list_endpoint("agents/completions", offset, limit).await
    }

    pub async fn list_vector_completions(&self, offset: usize, limit: usize) -> Result<Vec<ListItem>, super::super::Error> {
        self.list_endpoint("vector/completions", offset, limit).await
    }

    pub async fn list_function_executions(&self, offset: usize, limit: usize) -> Result<Vec<ListItem>, super::super::Error> {
        self.list_endpoint("functions/executions", offset, limit).await
    }

    pub async fn list_function_inventions(&self, offset: usize, limit: usize) -> Result<Vec<ListItem>, super::super::Error> {
        self.list_endpoint("functions/inventions", offset, limit).await
    }

    pub async fn list_function_inventions_recursive(&self, offset: usize, limit: usize) -> Result<Vec<ListItem>, super::super::Error> {
        self.list_endpoint("functions/inventions/recursive", offset, limit).await
    }

    // pub async fn list_function_profile_computations(&self, offset: usize, limit: usize) -> Result<Vec<ListItem>, super::super::Error> {
    //     self.list_endpoint("functions/profiles/computations", offset, limit).await
    // }

    pub async fn list_laboratory_executions(&self, offset: usize, limit: usize) -> Result<Vec<ListItem>, super::super::Error> {
    ...
    async fn clear_endpoint(&self, endpoint: &str) -> Result<u64, super::super::Error> {
        let dir = self.endpoint_dir(endpoint);
        match tokio::fs::metadata(&dir).await {
    ...
    pub async fn clear_agent_completions(&self) -> Result<u64, super::super::Error> {
        self.clear_endpoint("agents/completions").await
    }

    pub async fn clear_agent_completion_continuations(&self) -> Result<u64, super::super::Error> {
        self.clear_endpoint("agent/completions/continuation").await
    }

    pub async fn clear_agent_completion_messages(&self) -> Result<u64, super::super::Error> {
        self.clear_endpoint("agent/completions/messages").await
    }

    pub async fn clear_agent_completion_message_logprobs(&self) -> Result<u64, super::super::Error> {
        self.clear_endpoint("agent/completions/messages/logprobs").await
    }

    pub async fn clear_agent_completion_message_images(&self) -> Result<u64, super::super::Error> {
        self.clear_endpoint("agent/completions/messages/image").await
    }

    pub async fn clear_agent_completion_message_audio(&self) -> Result<u64, super::super::Error> {
        self.clear_endpoint("agent/completions/messages/audio").await
    }

    pub async fn clear_agent_completion_message_video(&self) -> Result<u64, super::super::Error> {
        self.clear_endpoint("agent/completions/messages/video").await
    }

    pub async fn clear_agent_completion_message_files(&self) -> Result<u64, super::super::Error> {
        self.clear_endpoint("agent/completions/messages/file").await
    }

    pub async fn clear_vector_completions(&self) -> Result<u64, super::super::Error> {
        self.clear_endpoint("vector/completions").await
    }

    pub async fn clear_function_executions(&self) -> Result<u64, super::super::Error> {
        self.clear_endpoint("functions/executions").await
    }

    pub async fn clear_function_execution_retry_tokens(&self) -> Result<u64, super::super::Error> {
        self.clear_endpoint("functions/executions/retry_token").await
    }

    pub async fn clear_function_inventions(&self) -> Result<u64, super::super::Error> {
        self.clear_endpoint("functions/inventions").await
    }

    pub async fn clear_function_inventions_recursive(&self) -> Result<u64, super::super::Error> {
        self.clear_endpoint("functions/inventions/recursive").await
    }

    pub async fn clear_laboratory_executions(&self) -> Result<u64, super::super::Error> {
    ...
    async fn read_json(&self, dir: &str, stem: &str) -> Result<serde_json::Value, super::super::Error> {
    ...
    async fn read_data_url_by_stem(&self, dir: &str, stem: &str) -> Result<String, super::super::Error> {
        use base64::Engine;
    ...
    pub async fn read_agent_completion(&self, id: &str) -> Result<serde_json::Value, super::super::Error> {
        self.read_json("agents/completions", id).await
    }

    pub async fn read_agent_completion_continuation(&self, id: &str) -> Result<serde_json::Value, super::super::Error> {
        self.read_json("agents/completions/continuation", id).await
    }

    pub async fn read_agent_completion_message(&self, id: &str, message_index: u64) -> Result<serde_json::Value, super::super::Error> {
        self.read_json("agents/completions/messages", &format!("{id}_{message_index}")).await
    }

    pub async fn read_agent_completion_message_logprobs(&self, id: &str, message_index: u64) -> Result<serde_json::Value, super::super::Error> {
        self.read_json("agents/completions/messages/logprobs", &format!("{id}_{message_index}")).await
    }

    pub async fn read_agent_completion_message_image(&self, id: &str, message_index: u64, media_index: u64) -> Result<String, super::super::Error> {
        self.read_data_url_by_stem("agents/completions/messages/image", &format!("{id}_{message_index}_{media_index}")).await
    }

    pub async fn read_agent_completion_message_audio(&self, id: &str, message_index: u64, media_index: u64) -> Result<String, super::super::Error> {
        self.read_data_url_by_stem("agents/completions/messages/audio", &format!("{id}_{message_index}_{media_index}")).await
    }

    pub async fn read_agent_completion_message_video(&self, id: &str, message_index: u64, media_index: u64) -> Result<String, super::super::Error> {
        self.read_data_url_by_stem("agents/completions/messages/video", &format!("{id}_{message_index}_{media_index}")).await
    }

    pub async fn read_agent_completion_message_file(&self, id: &str, message_index: u64, media_index: u64) -> Result<String, super::super::Error> {
    ...
    pub async fn read_vector_completion(&self, id: &str) -> Result<serde_json::Value, super::super::Error> {
    ...
    pub async fn read_function_execution(&self, id: &str) -> Result<serde_json::Value, super::super::Error> {
        self.read_json("functions/executions", id).await
    }

    pub async fn read_function_execution_retry_token(&self, id: &str) -> Result<serde_json::Value, super::super::Error> {
    ...
    pub async fn read_function_invention(&self, id: &str) -> Result<serde_json::Value, super::super::Error> {
    ...
    pub async fn read_function_invention_recursive(&self, id: &str) -> Result<serde_json::Value, super::super::Error> {
    ...
    pub async fn read_laboratory_execution(&self, id: &str) -> Result<serde_json::Value, super::super::Error> {
    ...
    async fn subscribe_json(
        ...
        let full = self.logs_dir().join(dir).join(format!("{stem}.json"));
        self.poll_file(&full, timeout, require_modification).await?;
    ...
    pub async fn subscribe_agent_completion(&self, id: &str, timeout: std::time::Duration, require_modification: bool) -> Option<serde_json::Value> {
        self.subscribe_json("agents/completions", id, timeout, require_modification).await
    }

    pub async fn subscribe_agent_completion_continuation(&self, id: &str, timeout: std::time::Duration, require_modification: bool) -> Option<serde_json::Value> {
        self.subscribe_json("agents/completions/continuation", id, timeout, require_modification).await
    }

    pub async fn subscribe_agent_completion_message(&self, id: &str, message_index: u64, timeout: std::time::Duration, require_modification: bool) -> Option<serde_json::Value> {
        self.subscribe_json("agents/completions/messages", &format!("{id}_{message_index}"), timeout, require_modification).await
    }

    pub async fn subscribe_agent_completion_message_logprobs(&self, id: &str, message_index: u64, timeout: std::time::Duration, require_modification: bool) -> Option<serde_json::Value> {
        self.subscribe_json("agents/completions/messages/logprobs", &format!("{id}_{message_index}"), timeout, require_modification).await
    }
    ...
    pub async fn subscribe_vector_completion(&self, id: &str, timeout: std::time::Duration, require_modification: bool) -> Option<serde_json::Value> {
        self.subscribe_json("vector/completions", id, timeout, require_modification).await
    }
    ...
    pub async fn subscribe_function_execution(&self, id: &str, timeout: std::time::Duration, require_modification: bool) -> Option<serde_json::Value> {
        self.subscribe_json("functions/executions", id, timeout, require_modification).await
    }

    pub async fn subscribe_function_execution_retry_token(&self, id: &str, timeout: std::time::Duration, require_modification: bool) -> Option<serde_json::Value> {
        self.subscribe_json("functions/executions/retry_token", id, timeout, require_modification).await
    }
    ...
    pub async fn subscribe_function_invention(&self, id: &str, timeout: std::time::Duration, require_modification: bool) -> Option<serde_json::Value> {
        self.subscribe_json("functions/inventions", id, timeout, require_modification).await
    }
    ...
    pub async fn subscribe_function_invention_recursive(&self, id: &str, timeout: std::time::Duration, require_modification: bool) -> Option<serde_json::Value> {
        self.subscribe_json("functions/inventions/recursive", id, timeout, require_modification).await
    }
    ...
    pub async fn subscribe_laboratory_execution(&self, id: &str, timeout: std::time::Duration, require_modification: bool) -> Option<serde_json::Value> {
        self.subscribe_json("laboratories/executions", id, timeout, require_modification).await
    }
}
