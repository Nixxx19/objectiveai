...
pub fn json_schemas() -> Vec<schemars::Schema> {
    let mut schemas = vec![
        ...
        schemars::schema_for!(crate::functions::inventions::prompt::Prompt),
        schemars::schema_for!(crate::functions::inventions::prompt::RemotePrompt),
        schemars::schema_for!(crate::functions::inventions::prompt::InlinePrompt),
        schemars::schema_for!(crate::functions::inventions::prompt::InlinePromptOrRemoteCommitOptional),
        schemars::schema_for!(crate::functions::inventions::prompt::StepPromptExpression),
        schemars::schema_for!(crate::functions::inventions::prompt::StepPromptType),
        schemars::schema_for!(crate::functions::inventions::prompt::request::ListPromptsRequest),
        schemars::schema_for!(crate::functions::inventions::prompt::request::ListPromptsSource),
        schemars::schema_for!(crate::functions::inventions::prompt::response::ListPromptResponse),
        schemars::schema_for!(crate::functions::inventions::prompt::response::GetPromptResponse),
        schemars::schema_for!(crate::functions::inventions::prompt::response::UsagePromptResponse),
