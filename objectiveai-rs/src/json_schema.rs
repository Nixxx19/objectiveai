...
pub fn json_schemas() -> Vec<schemars::Schema> {
    let mut schemas = vec![
        ...
        schemars::schema_for!(crate::functions::expression::Params<'static, 'static>),
        schemars::schema_for!(crate::functions::expression::ParamsOwned),
        schemars::schema_for!(crate::functions::expression::ParamsRef<'static, 'static>),
        schemars::schema_for!(crate::functions::expression::TaskOutput<'static>),
        schemars::schema_for!(crate::functions::expression::TaskOutputOwned),
        schemars::schema_for!(crate::functions::expression::TaskOutputRef<'static>),
        ...
        schemars::schema_for!(crate::vector::completions::cache::request::CacheVoteRequest<'static>),
        schemars::schema_for!(crate::vector::completions::cache::request::CacheVoteRequestRef<'static>),
