...
pub struct ChatCompletionChunk {
    ...
    pub choices:
        Vec<crate::chat::completions::response::streaming::Choice>,
    /// Unix timestamp when the completion was created.
    pub created: u64,
    /// The model that generated this completion.
    pub model: String,
    /// Object type indicator.
    pub object: crate::chat::completions::response::streaming::Object,
...
impl ChatCompletionChunk {
    ...
    ) -> crate::chat::completions::response::streaming::ChatCompletionChunk
    {
        crate::chat::completions::response::streaming::ChatCompletionChunk {
            id,
            upstream_id: self.id,
    ...
    fn push_choices(
        &mut self,
        other_choices: &[crate::chat::completions::response::streaming::Choice],
    ) {
        fn push_choice(
            choices: &mut Vec<
                crate::chat::completions::response::streaming::Choice,
            >,
            other: &crate::chat::completions::response::streaming::Choice,
        ) {
            fn find_choice(
                choices: &mut Vec<crate::chat::completions::response::streaming::Choice>,
                index: u64,
            ) -> Option<&mut crate::chat::completions::response::streaming::Choice>
            {
