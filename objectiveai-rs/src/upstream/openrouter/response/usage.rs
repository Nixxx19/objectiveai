...
pub struct Usage {
    ...
    pub completion_tokens_details:
        Option<crate::agent::completions::response::CompletionTokensDetails>,
    /// Detailed breakdown of prompt tokens.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub prompt_tokens_details:
        Option<crate::agent::completions::response::PromptTokensDetails>,
...
impl Usage {
    ...
    pub fn into_downstream(
    ...
    ) -> crate::agent::completions::response::Usage {
        ...
        let (cost, cost_details, total_cost) = if is_byok {
            (
                ...
                Some(crate::agent::completions::response::CostDetails {
                    upstream_inference_cost,
    ...
    pub fn push(&mut self, other: &Usage) {
        ...
        crate::agent::completions::response::util::push_option_decimal(
            &mut self.cost,
            &other.cost,
        );
