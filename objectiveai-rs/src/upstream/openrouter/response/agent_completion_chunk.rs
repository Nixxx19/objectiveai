...
/// A streaming agent completion chunk from OpenRouter.
///
...
pub struct AgentCompletionChunk {
    ...
    pub choices:
        Vec<crate::agent::completions::response::streaming::Choice>,
    /// Unix timestamp when the completion was created.
    pub created: u64,
    /// The model that generated this completion.
    pub model: String,
    /// Object type indicator.
    pub object: crate::agent::completions::response::streaming::Object,
...
impl AgentCompletionChunk {
    ...
    fn push_choices(
        &mut self,
        other_choices: &[crate::agent::completions::response::streaming::Choice],
    ) {
        fn push_choice(
            choices: &mut Vec<
                crate::agent::completions::response::streaming::Choice,
            >,
            other: &crate::agent::completions::response::streaming::Choice,
        ) {
            fn find_choice(
                choices: &mut Vec<crate::agent::completions::response::streaming::Choice>,
                index: u64,
            ) -> Option<&mut crate::agent::completions::response::streaming::Choice>
            {
