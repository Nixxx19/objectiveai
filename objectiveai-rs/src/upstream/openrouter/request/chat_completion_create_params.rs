...
pub struct ChatCompletionCreateParams {
    ...
    pub messages: Vec<crate::chat::completions::request::Message>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub stop: Option<crate::ensemble_llm::Stop>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub reasoning: Option<crate::ensemble_llm::Reasoning>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub verbosity: Option<crate::ensemble_llm::Verbosity>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub response_format: Option<crate::chat::completions::request::ResponseFormat>,
    /// Random seed from request.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub seed: Option<i64>,
    /// Tool choice configuration from request.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub tool_choice: Option<crate::chat::completions::request::ToolChoice>,
    /// Available tools from request.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub tools: Option<Vec<crate::chat::completions::request::Tool>>,
    /// Whether to allow parallel tool calls from request.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub parallel_tool_calls: Option<bool>,
    /// Prediction hints from request.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub prediction: Option<crate::chat::completions::request::Prediction>,
...
impl ChatCompletionCreateParams {
    ...
    pub fn new_for_chat(
        ...
        request: &crate::chat::completions::request::ChatCompletionCreateParams,
    ) -> Self {
        Self {
