//! Agent completion request parameters for OpenRouter.

use indexmap::IndexMap;
use serde::{Deserialize, Serialize};

/// Agent completion request parameters formatted for the OpenRouter API.
///
...
impl AgentCompletionCreateParams {
    /// Creates request parameters for a agent completion.
    ///
    ...
    pub fn new_for_agent(
        ...
        Self {
            messages: super::prompt::new_for_agent(
    ...
    ///
    /// Transforms the vector completion request into a agent completion that asks
