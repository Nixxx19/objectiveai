...
func (FunctionsProfilesComputationsResponseUnaryFunctionExecution) JSONSchema() map[string]any {
	return map[string]any{
		"title": "functions.profiles.computations.response.unary.FunctionExecution",
