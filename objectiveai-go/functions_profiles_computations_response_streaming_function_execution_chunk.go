...
func (FunctionsProfilesComputationsResponseStreamingFunctionExecutionChunk) JSONSchema() map[string]any {
	return map[string]any{
		"title": "functions.profiles.computations.response.streaming.FunctionExecutionChunk",
		"type": "object",
