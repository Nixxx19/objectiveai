...
type FunctionsVectorCompletionTaskExpression struct {
	...
	Messages FunctionsExpressionWithExpressionArrayOfFunctionsExpressionWithExpressionAgentCompletionsMessageMessageExpression `json:"messages"`
	Output FunctionsExpressionExpression `json:"output"`
	Responses FunctionsExpressionWithExpressionArrayOfFunctionsExpressionWithExpressionAgentCompletionsMessageRichContentExpression `json:"responses"`
	Skip *FunctionsExpressionExpression `json:"skip,omitempty"`
}

func (FunctionsVectorCompletionTaskExpression) JSONSchema() map[string]any {
