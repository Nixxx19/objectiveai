...
func (VectorCompletion) SchemaTitle() string { return "vector.completions.response.unary.VectorCompletion" }
func (VectorCompletion) SchemaDescription() string { return "A complete vector completion response (non-streaming).\n\nContains the final scores, all votes from the ensemble, and the underlying\nagent completions that produced those votes." }
func (VectorCompletion) FieldDescriptions() map[string]string {
