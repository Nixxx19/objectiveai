...
func (VectorCompletionsResponseStreamingAgentCompletionChunk) SchemaDescription() string { return "A streaming agent completion chunk from a single agent within a vector completion.\n\nThe `index` field is used to correlate chunks belonging to the same\nunderlying completion when accumulating via [`push`](Self::push)." }
func (VectorCompletionsResponseStreamingAgentCompletionChunk) FieldDescriptions() map[string]string {
