...
func (AgentClaudeAgentSdkAgentBase) SchemaDescription() string { return "The base configuration for a Claude Agent SDK Agent (without computed ID)." }
func (AgentClaudeAgentSdkAgentBase) FieldDescriptions() map[string]string {
