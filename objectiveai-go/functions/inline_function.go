...
type InlineFunctionVariant2 struct {
	InputMerge any `json:"input_merge,omitempty"`
	InputSplit any `json:"input_split,omitempty"`
	Tasks []any `json:"tasks"`
	Type string `json:"type"`
}
...
func (InlineFunctionSchema) SchemaTitle() string { return "functions.InlineFunction" }
func (InlineFunctionSchema) SchemaDescription() string { return "An inline function definition without metadata.\n\nUsed when embedding function logic directly in requests rather than\nreferencing a remote function. Lacks description and input\nschema fields." }
