...
func (GetFunction) SchemaTitle() string { return "functions.GetFunction" }
func (GetFunction) SchemaDescription() string { return "A remote function with full metadata.\n\nRemote functions are stored as `function.json` in repositories and\nreferenced by `remote/owner/repository`. They include documentation fields\nthat inline functions lack." }

func (GetFunction) Body() map[string]any {
