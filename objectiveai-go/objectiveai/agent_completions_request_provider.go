...
type AgentCompletionsRequestProvider struct {
	...
	MaxLatency *float64 `json:"max_latency,omitempty" validate:"min=-3.4028234663852886e+38,max=3.4028234663852886e+38"`
	...
	MinThroughput *float64 `json:"min_throughput,omitempty" validate:"min=-3.4028234663852886e+38,max=3.4028234663852886e+38"`
	// Preferred maximum latency (seconds).
	PreferredMaxLatency *float64 `json:"preferred_max_latency,omitempty" validate:"min=-3.4028234663852886e+38,max=3.4028234663852886e+38"`
	// Preferred minimum throughput (tokens/second).
	PreferredMinThroughput *float64 `json:"preferred_min_throughput,omitempty" validate:"min=-3.4028234663852886e+38,max=3.4028234663852886e+38"`
