...
func (FunctionsExecutionsRequestFunctionInlineProfileInlineRequestBody) SchemaTitle() string { return "functions.executions.request.FunctionInlineProfileInlineRequestBody" }
func (FunctionsExecutionsRequestFunctionInlineProfileInlineRequestBody) SchemaDescription() string { return "Request body for inline Function with inline Profile." }
func (FunctionsExecutionsRequestFunctionInlineProfileInlineRequestBody) FieldDescriptions() map[string]string {
...
func (v FunctionsExecutionsRequestFunctionInlineProfileInlineRequestBody) Validate() error {
