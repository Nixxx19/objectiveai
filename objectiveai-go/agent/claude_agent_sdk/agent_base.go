...
func (AgentBase) SchemaTitle() string { return "agent.claude_agent_sdk.AgentBase" }
func (AgentBase) SchemaDescription() string { return "The base configuration for a Claude Agent SDK Agent (without computed ID)." }
