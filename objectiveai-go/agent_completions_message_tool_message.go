...
func (AgentCompletionsMessageToolMessage) SchemaDescription() string { return "A tool message containing the result of a tool call." }
func (AgentCompletionsMessageToolMessage) FieldDescriptions() map[string]string {
