...
func (AgentOpenrouterAgentBase) SchemaDescription() string { return "The base configuration for an OpenRouter Agent (without computed ID)." }
func (AgentOpenrouterAgentBase) FieldDescriptions() map[string]string {
