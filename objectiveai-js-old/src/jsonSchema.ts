...
const schemaRefs: string[] = [
  ...
  "CompletionProvider",
  "Upstream",
  "AlphaScalarScalarFunctionTaskExpression",
  "AlphaScalarVectorCompletionTaskExpression",
  "AlphaScalarPlaceholderScalarFunctionTaskExpression",
  "AlphaVectorScalarFunctionTaskExpression",
  "AlphaVectorVectorFunctionTaskExpression",
  "AlphaVectorVectorCompletionTaskExpression",
  "AlphaVectorPlaceholderScalarFunctionTaskExpression",
  "AlphaVectorPlaceholderVectorFunctionTaskExpression",
  "ChatCompletionUsage",
