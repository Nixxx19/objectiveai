...
export default function AppShell({ children }: { children: React.ReactNode }) {
  ...
  // Landing page: add body class for scoped styling
  useEffect(() => {
    if (isLanding) {
  ...
  const navLinks = [
    ...
    { href: "https://github.com/ObjectiveAI/objectiveai", label: "GitHub", external: true },
  ];

  return (
    <>
      {/* Navigation — flat, no pill */}
      <nav
        ref={navRef}
        className={isLanding ? 'site-nav site-nav-landing' : 'site-nav'}
      >
        <div className="site-nav-inner" style={{
          ...
          {/* Right: Nav Links + Discord + Profile */}
          <div className="site-nav-right">
            ...
            {!isMobile && (
              <>
                ...
                <Link href="/api/auth/signin" className="site-nav-cta">
                  Sign Up
                </Link>
              </>
            )}
            ...
            {isMobile && (
              ...
              >
                <span style={{
                  ...
                  background: 'var(--text)', borderRadius: '1px',
                  transition: 'all 0.3s',
