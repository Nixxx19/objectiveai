    ...
    <div className="page">
      <div className="container">
        ...
        <div style={{ marginBottom: '32px' }}>
          ...
          <div className="skeleton" style={{ width: '280px', maxWidth: '100%', height: '28px', borderRadius: '6px', marginBottom: '8px' }} />
          <div className="skeleton" style={{ width: '140px', maxWidth: '100%', height: '14px', borderRadius: '4px' }} />
        </div>
