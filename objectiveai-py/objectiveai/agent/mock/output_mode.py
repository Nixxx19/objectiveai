...
class AgentMockOutputModeVariant1(RootModel):
...
class AgentMockOutputModeVariant2(RootModel):
...
class AgentMockOutputModeVariant3(RootModel):
...
class AgentMockOutputMode(RootModel):
...
completely ignored for agent completions."""
    ...
    root: Union[AgentMockOutputModeVariant1, AgentMockOutputModeVariant2, AgentMockOutputModeVariant3]
