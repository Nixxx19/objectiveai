...
from objectiveai.agent.completions.response.prompt_tokens_details import (
    AgentCompletionsResponsePromptTokensDetails,
)


def _push(self, other: AgentCompletionsResponsePromptTokensDetails) -> None:
...
AgentCompletionsResponsePromptTokensDetails.push = _push
