...
class FunctionsRemoteFunctionVariant1(BaseModel):
...
class FunctionsRemoteFunctionVariant2(BaseModel):
...
class FunctionsRemoteFunction(RootModel):
...
that inline functions lack."""
    ...
    root: Union[FunctionsRemoteFunctionVariant1, FunctionsRemoteFunctionVariant2]
