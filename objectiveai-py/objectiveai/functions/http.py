...
async def list_functions(
    ...
    return await client.get_unary("functions/list", params)
...
async def get_function(
    ...
    return await client.get_unary("functions", params)
...
async def get_function_usage(
    ...
    return await client.get_unary("functions/usage", params)
...
async def list_function_profile_pairs(
    ...
    return await client.get_unary("functions/profiles/pairs/list", params)
...
async def get_function_profile_pair_usage(
    ...
    return await client.get_unary("functions/profiles/pairs/usage", params)
